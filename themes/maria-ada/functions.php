...
if ( ! function_exists( 'maria_ada_setup' ) ) :
	...
	function maria_ada_setup() {
		 ...
		 * If you're building a theme based on Maria Ada, use a find and replace
		 * to change 'maria-ada' to the name of your theme in all the template files.
		 */
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'maria-ada' ),
		) );
...
function maria_ada_scripts() {
	...
	wp_enqueue_script( 'maria-ada-scripts-main', get_template_directory_uri() . '/js/bundled.js');
